...
const leverageTest = async () => {
    ...
    let route = await oneWayMarket.leverage.createLoanRoute(userBorrowed, debt);
    console.log(route);
    ...
    route = await oneWayMarket.leverage.borrowMoreRoute(userBorrowed, debt);
    console.log(route);
    for (const r of route) {
        console.log(r);
        console.log(r.part);
    ...
    route = await oneWayMarket.leverage.repayRoute(stateCollateral, userCollateral);
    console.log(route);
    for (const r of route) {
        console.log(r);
        console.log(r.part);
